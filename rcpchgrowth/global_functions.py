...
def generate_centile(
    ...
    for age in AGES:
        ...
        if default_youngest_reference:
            print(default_youngest_reference, reference_name, age)
        try:
